        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
          <LegalCard
            ...
            description={
              <>
                <Paragraph>
                  nowfar.lol functions as a search engine and content aggregator
                ...
                <Link to="/about">Learn more about how nowfar.lol works</Link>
              </>
            }
          />
          ...
          <LegalCard
            ...
            description={
              <Paragraph>
                ...
                <br />
                <br />
                nowfar.lol is entirely self hostable, and can be run on any
          ...
          <LegalCard
            ...
            description={
              <Paragraph>
                nowfar.lol is licensed under the MIT license.
                <br />
                <br />
          ...
          <LegalCard
            ...
            description={
              <Paragraph>
                ...
                <br />
                <br />
                nowfar.lol operates within legal boundaries and cooperates with
